...
\item{havayolu_kodu}{Havayolu şirketinin 2 harfli kısaltması. Adlarına ulaşmak için: veriler::havayolları}
\item{uçuş}{Uçuş numarası}
\item{kuyruk_numarası}{Uçak kuyruk numarası. Uçak kılavuz verileri için: veriler::uçaklar}
\item{orijin}{Kalkış noktası. Havalimanı kılavuz verileri için: veriler::havalimanları}
\item{varış_noktası}{Varış noktası. Havalimanı kılavuz verileri için: veriler::havalimanları}
...
\item{tarih_saat}{POSIXct formatında planlanan uçuş tarihi ve saati. Uçuş verilerini, veriler::hava_durumu verileriyle birleştirmek için, orijin değişkeniyle birlikte kullanılabilir}
}}
\usage{uçuşlar}
