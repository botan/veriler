...
\item{medeni_durum}{Medeni durum}
\item{yaş}{Yaş. Maksimum 89 ile sınırlı}
\item{ırk}{Irk}
\item{gelir}{Bildirilen gelir (ABD Doları)}
\item{parti}{Siyasi parti tercihi}
\item{din}{Dini inanç}
\item{mezhep}{Bağlı olduğu mezhep}
